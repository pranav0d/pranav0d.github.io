...
Education
======
* M.S. in Cybersecurity with Emphasis in Artificial Intelligence, Webster University, St. Louis, MO, USA, 2026
* B.E. in Electronics & Communication Engineering, Matrusri Engineering College (Osmania University), Hyderabad, India, 2023

Experience
======
* **Research Assistant**, Webster University — St. Louis, MO (Jan 2026 – May 2026)
...
* **AI-Driven Intruder Detection (IoT & Computer Vision)**
  * Built an intrusion detection system using motion sensors, the Discord API, and computer vision techniques with OpenCV
  * Implemented real-time alerts with model inference for face detection and edge-device integration using PyTorch
...
* **Hybrid Hexapod Robot with AI-Based Disease Classification**
  * Designed a robotic platform for autonomous agricultural monitoring using Node.js and the PyQt library
  * Modeled the robot in Fusion 360 and 3D printed it
  * Implemented image classification via RNNs and transfer learning on Raspberry Pi
  * Integrated feature extraction, model evaluation, and predictive analytics
  * [Project demo](https://drive.google.com/file/d/1LG9y35iKhGacuAVbIrhXHc2bpjcnMLFp/view?usp=sharing)
...
* **AI Deployment & Tools**
  ...
  * PyTorch, TensorFlow, Keras, Hugging Face Transformers, OpenCV
  * Docker, Kubernetes
